...
#import "DTTableAccordionViewController.h"


@interface DTTableAccordionViewController (Private)
- (void)closeSectionWithHeader:(DTTableAccordionHeader*)headerView;
- (void)openSection:(NSUInteger)section withHeader:(DTTableAccordionHeader*)headerView;
@end


@implementation DTTableAccordionViewController
...
- (DTTableAccordionHeader *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	DTTableAccordionHeader *headerView = [[DTTableAccordionHeader alloc] initWithFrame:CGRectMake(0, 
																						0, 
...
- (void)handleTapGestureOnHeader:(UIGestureRecognizer *)gestureRecognizer {
	DTTableAccordionHeader *header = (DTTableAccordionHeader*)gestureRecognizer.view;
